...
export default function player() {
  return (
    <div className='h-[10%] bg-black flex justify-between items-center px-4 text-white px-4'>
      <div className=' hidden lg:flex items-center gap-4'>
        <img className='w-12'
          src={songsData[0].image} alt="album" />
        <div>
      ...
      <div className="flex flex-col items-center gap-1 m-auto">
        ...
        <div className="w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer">
          <hr className="bg-green-800  border-none w-0 h-1 rounded-full" />
          </div>
        <p>3:20</p>
      </div>
      </div>
